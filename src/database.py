...
class RatmasDB:
    ...
    def add_assignment(self, sender_id: int, receiver_id: int, is_official: bool = True, packages_count: int = 0):
    ...
    def update_package_count(self, sender_id: int, receiver_id: int, count: int, is_official: bool = False):
        ...
        if assignment:
            ...
            self.add_assignment(sender_id, receiver_id, is_official=is_official, packages_count=count)
