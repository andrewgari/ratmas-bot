...
class ReminderButton(ui.Button):
    ...
    def __init__(self, sender_id: int, receiver_id: int, original_message: str, bot, db: "RatmasDB"):
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        await interaction.response.send_message(
            "✅ Reminder sent! The manager has also been notified.",
            ephemeral=True
        )
...
class EscalateModal(ui.Modal, title="Escalate to Manager"):
    ...
    async def on_submit(self, interaction: discord.Interaction):
        ...
        try:
            ...
            await interaction.response.send_message(
                "❌ Failed to escalate. Please contact the manager directly.",
                ephemeral=True
            )
...
def create_message_buttons(sender_id: int, receiver_id: int, original_message: str, bot, db: "RatmasDB") -> ui.View:
